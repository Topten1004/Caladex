...
const CurrentOrderList = (props) => {
    ...
    const onClickSearch = async () => {
       ...
       await GetOrderHistory(account , start_time , end_time , token_id , pair_type , orderType , false) ;
    }
    ...
    useEffect(async () => {
        if(!isLoading) {
            await GetOrderHistory(account, start_time , end_time , null , null , null , false );
        }
    } , [isLoading])
    return (
